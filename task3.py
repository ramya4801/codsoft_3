...
class todo:
 def __init__(self, root):
    ...
    self.root.geometry('600x400+300+150')

    self.label = Label(self.root, text='To-Do-List',
                        font='ariel,25 ',width=10,bd=5,bg='green',fg='black')
    self.label.pack(side='top',fill=BOTH)
    self.label2 = Label(self.root, text='Add Task',
                        font='ariel,18 ',width=10,bd=5,bg='green',fg='black')
    ...
    self.text = Text(self.root, bd=3, height=2, width=30, font='ariel, 10')
